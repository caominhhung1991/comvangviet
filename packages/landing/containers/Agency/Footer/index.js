...
import { GENERAL, SECTIONS } from "common/src/constants/appConstants";
...
const Footer = ({
  ...
  return (
    <FooterWrapper id={SECTIONS.lienHe.id}>
      <Container>
        <Box className="row" {...row}>
          <Box {...colOne}>
            <Logo
              ...
              logoStyle={logoStyle}
            />
            <Text content={GENERAL.contact.email} {...textStyle} />
            <Text content={GENERAL.contact.displayPhone} {...textStyle} />
          </Box>
