...
import { SANPHAM_INFO } from "common/src/constants/appConstants";
...
const BlogSection = ({
  ...
  return (
    <BlogSectionWrapper id={SANPHAM_INFO.id}>
      <Container>
        <Box {...sectionHeader}>
          <Text content={SANPHAM_INFO.title} {...sectionSubTitle} />
          <Heading
            content={SANPHAM_INFO.description}
            {...sectionTitle}
          />
        </Box>
