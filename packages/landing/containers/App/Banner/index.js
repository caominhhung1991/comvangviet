...
import { ButtonWrapper, DiscountLabel, DiscountWrapper, EmailInputWrapper } from './banner.style';

import AppScreenshot from 'common/src/assets/image/app/mobile.png';

const DomainSection = (props) => {
  const {
    SectionWrapper, row, col, title, description,
    button, image, imageArea, btnStyle,
    btnStyleTwo, discountAmount, discountText
  } = props;
